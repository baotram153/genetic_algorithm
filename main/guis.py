...
def trip_cell_poss(map):
    trip_cell_pos = [None, [(50,50)], [(1,2), (4,2)], [(50,50)], [(50,50)], [(50,50)], [(4,3)], [(50,50)]]
    return trip_cell_pos[map]

def flag_poss(map):
    flag_pos = [None, (4,5), (1,2), (2,1), (3,2), (5,3), (4,0), (0,2)]
    return flag_pos[map]

def start_pos_CELLs(map):
    start_pos_CELL = [None, (3,0), (4,5), (2,5), (2,3), (5,3), (0,4), (6,3)]
